...
HD_PWD='/home/javier/Development/zybo/base-hw/base-hw.runs/base_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_design_auto_pc_0.tcl
