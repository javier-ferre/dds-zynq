...
HD_PWD='/home/javier/Development/zybo/base-hw/base-hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log base_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source base_design_wrapper.tcl -notrace
