...
HD_PWD='/home/javier/Development/zybo/base-hw/base-hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_design_wrapper.tcl
